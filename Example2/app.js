...
.service('sheetAction', ['$location', 'sheets', function($loation, sheets) {
...
.controller('CreationController', ['$scope', 'counting', 'sheetAction', function CreationController($scope, counting, sheetAction) {
